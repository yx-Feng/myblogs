...
### 19. 消息队列了解吗？生产者，消费者，主题之间的关系，如何避免 消费者重复消费？是否允许多个生产者和消费者？
...
### 20. 在单台机器部署的情况下，如何对同一个用户加锁以确保接口的线程安全？
...
### 24. 怎么取消一个正在执行的任务？future和complatablefuture区别？
