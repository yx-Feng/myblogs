...
### 22. volatile关键字的主要作用，以及它为什么线程不安全？
...
### 37. 使用hashmap时，如果只重写了equals没有重写hashcode会出现什么问题
